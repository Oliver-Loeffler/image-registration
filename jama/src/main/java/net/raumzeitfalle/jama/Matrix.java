 ...
 * ------------------------ */
   ...
   */
   ...
   @return     A(i,j)
   @throws  ArrayIndexOutOfBoundsException if row and column indexes are outside bounds
   */
   ...
   */
   ...
   @param j    Column index.
   @param s    A(i,j).
   @throws ArrayIndexOutOfBoundsException if indexes are outside bounds
   */
   ...
   */
    ...
    * @return Matrix
    * @throws java.io.IOException on unexpected end of file
    */
